...
public class StoreManagerService {
     ...
     * @param[in] CustomerModel customer  The customer model .
     * @returns if customer is null then returns null or if there is
     * no order of this customer from the given StoreManagerModel , otherwise
     * returns the Order Model that represents the actuall order .
     */
